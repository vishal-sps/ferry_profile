        ...
        <div className="flex mb-14">
          <section className="md:w-1/2">
            ...
            <p className="mb-8 text-gray-500 p">
              {chef?.description}
            Feugiat in ante metus dictum at tempor. Dui into faucibus in ornare quam viverra. Elementum a facilisis leo vel fringilla. Feugiat in ante metus dictum at tempor. Dui into faucibus in ornare quam viverra. Elementum a facilisis leo vel fringilla. Feugiat in ante metus dictum at tempor. Dui into faucibus in ornare quam viverra. Elementum a facilisis leo vel fringilla.
